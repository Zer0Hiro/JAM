...
JAM files define instruments, sequences, patterns, and an arrangement. For the full syntax reference, see **[Syntax documentaion](https://zer0hiro.github.io/JAM-DSL-Compiler/)**.
